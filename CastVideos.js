...
CastPlayer.prototype.selectMedia = function(mediaIndex) {
    ...
    appendMessage('media selected' + mediaIndex);
    currentMediaURL = mediaJSON.categories[0].videos[mediaIndex].sources[0];
    currentMediaTitle = mediaJSON.categories[0].videos[mediaIndex].title;
    currentMediaThumb = mediaJSON.categories[0].videos[mediaIndex].thumb;
